...
export class FireHydrantController {
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_FIRE_HYDRANT,
  })
  @ApiBody({
  ...
  update(
    @Param("id") id: string,
    @Body() dto: Partial<UpdateFireHydrantDto>
  ): Promise<UpdateFireHydrantDto> {
