...
import {
  ...
  GetCurrentUserIdDecorator,
  Public,
} from "../__core/decorators";
import {
  AuthUserDto,
  ChangePasswordDto,
  ConfirmAccountDto,
...
export class AuthController {
  ...
  @ApiOkResponse({
    ...
    schema: {
      example: {
        access_token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTQsImVtYWlsIjoidXNlcjIwMUBnbWFpbC5jb20iLCJpYXQiOjE2NTU4NTEzODQsImV4cCI6MTY1NTg1MjI4NH0.KlgbHUF76K8PyD0QYDh1xgEcsB_HzfgD21X-aTlytYc",
        refresh_token:
          "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6MTQsImVtYWlsIjoidXNlcjIwMUBnbWFpbC5jb20iLCJpYXQiOjE2NTU4NTEzODQsImV4cCI6MTY1NjQ1NjE4NH0.bSJUZGZG-Z1uMP_z8uIWGEYQK-oonGlKDmnETI8ISGo",
      },
    },
  })
  @Post("register")
  ...
  async confirm(@Query() query: ConfirmAccountDto) {
    ...
    const userType = await this.authService.confirm(query.token);
  ...
  @ApiOkResponse({
    ...
    schema: {
      example: {
        access_token:
          "eyJhbGciOiJIUzI1NiIpXVCJ9.eyJpZCI6joidXNlcjIwbWFpbC5jb20iLCJpYXQiOjE2NTU4NTEzODQsImV4cCI6MTY1NTg1MjI4NH0.Klgbh1xgEcsB_HzfgD21X-aTlytYc",
        refresh_token:
          "eyJhbGciOiJIUzI1NiIsInpXVCJ9.eyJpZIjoidXNlcjIwbWFpbC5jb20iLCJpYXQiOjE2NTU4NTEzODQsImV4cCI6MTY1NjQ1NjE4NH0.bSJUZGZG-Z1uMGlKDmnETI8ISGo",
      },
    },
  })
