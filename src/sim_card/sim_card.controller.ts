...
import {
  SWAGGER_EXAMPLE_SIM_CARD,
  SWAGGER_EXAMPLE_SIM_CARD_LIST,
...
export class SimCardController {
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_SIM_CARD,
  })
  @ApiBody({
  ...
  @CustomOkResponse({
    status: HttpStatus.CREATED,
    exampleData: SWAGGER_EXAMPLE_SIM_CARD_LIST,
  })
