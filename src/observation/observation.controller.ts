...
import {SWAGGER_EXAMPLE_OBSERVATION, SWAGGER_EXAMPLE_OBSERVATION_LIST,} from "../__utils/example";
...
export class ObservationController {
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_OBSERVATION,
  })
  @ApiBody({
  ...
  @CustomOkResponse({
    status: HttpStatus.CREATED,
    exampleData: SWAGGER_EXAMPLE_OBSERVATION_LIST,
  })
  ...
  addSimCard(
    @Param("id") id: string,
    @Body("sim_card_id") sim_card_id: string
  ) {
    return this.observationService.addSimCard(Number(id), Number(sim_card_id));
  }

  @ApiOperation({summary: "Видалити sim card from observation"})
  @CustomOkResponse({
    status: HttpStatus.CREATED,
    exampleData: SWAGGER_EXAMPLE_OBSERVATION,
  })
