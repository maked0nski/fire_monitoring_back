...
export class FireExtinguishersController {
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_FIRE_EXTINGUISHER,
  })
  @ApiBody({
  ...
  @Post()
  create(
    @Body() dto: CreateFireExtinguishersDto
  ...
  @ApiParam({
    name: "id",
    description: "Fire fire extinguishers id",
    schema: { example: 1 },
  })
  @ApiForbiddenResponse({ description: Exception.FORBIDDEN })
  ...
  update(
    @Param("id") id: string,
    @Body() dto: UpdateFireExtinguishersDto
  ): Promise<CreateFireExtinguishersDto> {
  ...
  @ApiParam({
    name: "id",
    description: "Fire extinguishersn id",
    schema: { example: 1 },
  })
