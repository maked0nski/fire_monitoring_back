...
export class UserController {
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_USERS_LIST,
  })
  ...
  @CustomOkResponse({
    status: HttpStatus.OK,
    exampleData: SWAGGER_EXAMPLE_USERS_LIST_WITH_CAR,
  })
  @HttpCode(HttpStatus.OK)
  @Get("/withCar")
  ...
  @CustomOkResponse({
    status: HttpStatus.OK,
    exampleData: SWAGGER_EXAMPLE_USERS_LIST_WITH_POSITION,
  })
  @HttpCode(HttpStatus.OK)
  @Get("withPosition")
  ...
  @CustomOkResponse({
    status: HttpStatus.OK,
    exampleData: SWAGGER_EXAMPLE_USERS_LIST_WITH_CAR_AND_POSITION,
  })
  @HttpCode(HttpStatus.OK)
  ...
  @CustomOkResponse({
    status: HttpStatus.OK,
    exampleData: SWAGGER_EXAMPLE_USER_BY_ID,
  })
  ...
  async watchFile(@Param("id") id: string, @Res() res) {
    ...
    return res.sendFile(
      await this.userService.getById(Number(id)).then((value) => value.image),
      { root: "./files/image/" }
    );
  }
  ...
  @CustomOkResponse({
    ...
    exampleData: SWAGGER_EXAMPLE_USER,
  })
